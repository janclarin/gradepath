...
public abstract class BaseListFragment<T extends DatabaseItem> extends Fragment {
     ...
     */
    abstract protected void deleteSelectedItems(SparseBooleanArray selectedPositions);
    ...
    protected void setUpListView() {
        ...
        mListView.setMultiChoiceModeListener(new AbsListView.MultiChoiceModeListener() {
            ...
            public void onItemCheckedStateChanged(ActionMode mode, int position, long id, boolean checked) {
                ...
                mode.setTitle(Integer.toString(numItemsSelected) + " "
                        + mContext.getString(R.string.selected));
            }
